...
<html>
	...
	<head>
		<title>Welcome  To Book - Sign up, Log in, Post </title>
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Biobook"><b>ChatWorld</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
				...
				<li><a href="profile.php" title="Home"><label>Biography</label></a></li>
				<li><a href="photos.php" title="Settings"><label>Pictures</label></a></li>
				<li><a href="fun.php" title="Settings"><label>Fun</label></a></li>
